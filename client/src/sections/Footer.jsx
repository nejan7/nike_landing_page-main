    ...
    <footer className="max-container">
      ...
      >
        <div className="flex flex-col items-start ">
          ...
          <p
            className="text-white-400 mt-6 text-base leading-7 font-montserrat
          sm:max-w-sm"
          >
        ...
        <div
          className="flex flex-1 justify-between lg:gat-10 gap-20
        flex-wrap"
        >
      ...
      max-sm:items-center">
        <div className="flex flex-1 items-center gap-2 font-montserrat cursor-pointer">
          <img src={copyrightSign} alt="copy right sign" width={24} height={20}
